...
public class ExceptionHandlerGlobal extends ResponseStatusExceptionHandler {
    public ExceptionHandlerGlobal() {
        super();
    }
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(BookMyAviaException.class)
